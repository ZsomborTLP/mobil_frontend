          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <View>
                ...
                <TouchableOpacity style={{ backgroundColor: "#06c995", width: 175, height: 45, padding: 8, marginLeft: 82, borderRadius: 5 }} onPress={() => navigation.navigate('KiiratPlaystation', { nev: item.alkatresz_info, kep: item.alkatresz_kep, ar: item.alkatresz_ar, ev: item.alkatresz_garancia })}>
