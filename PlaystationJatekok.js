      ...
      <View style={{ flex: 1, padding: 24,marginBottom:-20,marginTop:-20}}>
        ...
        {isLoading ? (
          ...
          <FlatList
            ...
            <TouchableOpacity style={{ textAlign:'center', backgroundColor: "#06c995", width: 175, height: 45, padding: 8,marginLeft:60,borderRadius:5 }} onPress={() => navigation.navigate('Játék_Playstation', {id:item.jatekok_id,nev:item.jatekok_nev, kep:item.jatekok_kep, ar:item.jatekok_ar, ev:item.jatekok_megjelenes, trailer:item.jatekok_trailer })}>
